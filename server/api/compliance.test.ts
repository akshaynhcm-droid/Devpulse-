...
describe('Compliance Router', () => {
  describe('generateReport', () => {
    ...
    it('should generate OWASP report', async () => {
      ...
      const complianceScore = ((requirements.length - manualRequirements) / requirements.length) * 100;
  ...
  describe('listReports', () => {
    it('should list compliance reports for collection', async () => {
      ...
      const mockReports = [
        { id: 'r1', reportType: 'pci_dss', complianceScore: '75.0', totalRequirements: 10, metRequirements: 7, createdAt: new Date() },
        { id: 'r2', reportType: 'owasp', complianceScore: '60.0', totalRequirements: 10, metRequirements: 6, createdAt: new Date() },
      ];
  ...
  describe('getReport', () => {
    ...
    it('should deny access to other user report', async () => {
      ...
      expect(() => validateReportAccess(report, ctx.user.id)).toThrow('Report not found or access denied');
    });
