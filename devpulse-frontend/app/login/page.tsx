...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError("Please use Google Sign-in for now. Password login coming soon.");
    } catch {
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-slate-800 p-8 rounded-xl border border-slate-700 space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center">
                <input type="checkbox" className="rounded border-slate-600 bg-slate-700 text-blue-600" />
          ...
          <p className="text-center text-gray-400 text-sm">
            ...
            <a href={`${APP_URL}/api/oauth/login`} className="text-blue-400 hover:text-blue-300">
